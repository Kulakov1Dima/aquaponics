...
public class aquaponics2021_0_0_4v extends PApplet {
...
public void setupWindow() {
  ...
  text(received, width/2+width/6-width/70, height/7+height/100);
  if (data.length()!=0)text(data, width/15, height/2+height/3);
  portTime=1;
  if (data.length()!=0)println(data);
}
  public void settings() {  fullScreen(); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "aquaponics2021_0_0_4v" };
    if (passedArgs != null) {
